...
parser = argparse.ArgumentParser(description='Script to import Calm blueprints automatically from a directory')
parser.add_argument("-d", required=True, help="Directory to read from")
